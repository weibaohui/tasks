...
export const UserManagementPage: React.FC = () => {
  ...
  return (
    <div style={{ padding: 0 }}>
      ...
      <Modal title="新建用户" open={createOpen} footer={null} onCancel={() => setCreateOpen(false)} width={{ xs: '100%', md: 420 }} styles={{ body: { paddingRight: 8 } }}>
      ...
      <Modal title="编辑用户" open={!!editingUser} footer={null} onCancel={() => setEditingUser(null)} width={{ xs: '100%', md: 420 }} styles={{ body: { paddingRight: 8 } }}>
